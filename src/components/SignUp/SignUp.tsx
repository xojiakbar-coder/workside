...
const SignUp = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen min-h-screen w-full px-[3%]">
      <div className="flex flex-col py-[40px] justify-between 576:w-[600px] w-full border border-ghost-bg-color px-[37px] h-max min-h-max rounded-[14px] gap-[60px]">
