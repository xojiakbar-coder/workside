...
const getTitleType = (
  ...
  switch (type) {
    ...
    case "secondary":
      return "font-semibold text-light md:text-[32px] sm:text-[28px] text-[24px] font-mont text-center py-[34px]";
    case "title":
    ...
    case "section":
      return "font-mont font-[600] text-center text-[24px] pt-[5px] pb-[40px]";
    case "danger-title":
