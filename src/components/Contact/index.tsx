  ...
  return (
    ...
    >
      ...
      <div className="flex 992:flex-row flex-col items-center gap-[30px] justify-center h-[50dvh] pb-[50px] min-h-[60dvh] max-h-[70dvh]">
        ...
        <form className="flex flex-col gap-x-[30px] gap-y-[48px] justify-between rounded-md 992:w-[50%] sm:w-[80%] w-full md:p-[40px] py-[30px] px-[20px] h-full bg-body-bg-color">
