...
export const regions = createListCollection<SelectItemType>({
  items: [
    ...
    { id: 2, label: "Buxoro", value: "buxoro" },
    { id: 3, label: "Farg'ona", value: "fargona" },
    { id: 4, label: "Jizzax", value: "jizzax" },
    { id: 5, label: "Qoraqalpog'iston", value: "qoraqalpogiston" },
    { id: 6, label: "Qashqadaryo", value: "qashqadaryo" },
    { id: 7, label: "Namangan", value: "namangan" },
    { id: 8, label: "Navoiy", value: "navoiy" },
    { id: 9, label: "Samarqand", value: "samarqand" },
    { id: 10, label: "Sirdaryo", value: "sirdaryo" },
    { id: 11, label: "Surxondaryo", value: "surxondaryo" },
    { id: 12, label: "Toshkent", value: "toshkent" },
    { id: 13, label: "Toshkent viloyati", value: "toshkent-viloyati" },
    { id: 14, label: "Xorazm", value: "xorazm" },
  ],
});
...
const defaultSelectData = createListCollection<SelectItemType>({
  items: [
    ...
    { id: 23, label: "Event menejer", value: "event-menejer" },
